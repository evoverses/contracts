...
async function update() {
  ...
  const contract = await ethers.getContractAt("HatcherHarry", "0x918eA0E87ef08a5931aD3777b8c0EB69e2Ce37Dd", accounts[0])
  //const begin = 30
  //const end = 70
...
//
  ...
  for (let i = 0; i < evoIds.length; i++) {
    ...
    const tx = await contract.setBaseAttributes(evoIds.slice(begin, end), attributeNestedMap.slice(begin, end));
    await tx.wait();
  }
  ...
  //   ["Dauntless", "Executive", "Restless", "Nervous", "Cunning", "Energetic", "Clever", "Confident", "Ignorant", "Arrogant", "Biting", "Aggressive", "Patient", "Mature", "Sensible", "Calm", "Rue", "Cautious", "Curious", "Discrete", "Loyal"] // nature
  // ]
  //const nameTx = await contract.setBaseAttributeStrings(0, evoIds, attrStrings[0]);
  //await nameTx.wait(1);
  ...
  //const tx = await contract.getPendingHatch("0xb7A0a50EC25E1Dc0151A85278594Af932DE96F08");
  //console.log(tx);
  //const tx2 = await contract.simulateHatch("0xb7A0a50EC25E1Dc0151A85278594Af932DE96F08");
  //console.log(tx2);
  //const address = "0xd3400337666eb7a256c7146372e61fa1466a9af0"
  //const ids = [2976]
  //const tx = await contract.adminReIncubate(address, ids);
  //await tx.wait(1)
}
update()
  .then(() => process.exit(0))
